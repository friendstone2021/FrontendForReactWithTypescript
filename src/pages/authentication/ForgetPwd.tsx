...
// action
import {actions} from "../../store/auth/forgetpwd/reducer.ts";
...
export const ForgetPwd = () => {
    ...
    const validation = useFormik({
        ...
        onSubmit: (values: UserInfo) => {
            ...
            dispatch(actions.actionSendResetPwdMailRequest(payload));
        },
    });

    const isSendMail = useSelector((state: RootState) => state.forgetpwd.isSendMail);
